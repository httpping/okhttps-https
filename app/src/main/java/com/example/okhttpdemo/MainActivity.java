...
//		});
	...
	public void httpsTest(){
		 VpHttpClient client = new VpHttpClient(this);
		String url = "https://120.25.93.63:8089/api/1.0/QRCodeServer/QRCode/GainHttpsContent";
		              //https://120.25.93.63:8089/api/1.0/QRCodeServer/QRCode/GainHttpsContent
		//url  = "https://www.baidu.com";
		client.post(url, new VpRequestParams(), new VpCallBack() {
			@Override
