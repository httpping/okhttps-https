...
public final class CustomTrustPEM {
  ...
  private InputStream trustedCertificatesInputStream() {
    ...
    return context.getResources().openRawResource(R.raw.a213679301700631) ;
  ...
  private SSLContext trustManagerForCertificates(InputStream in)
    ...
    for (Certificate certificate : certificates) {
      ...
      NetLog.d("cert"+certificateAlias,certificate.toString());
    }
